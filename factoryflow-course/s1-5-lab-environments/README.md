...
Goal: **another pair clones your repository and gets it running in five minutes,
...
| 4 | `uv add --dev pytest ruff` — the tools *you* need, which a user does not |
...
**Step 6 is the one to actually do.** Delete the folder, feel the moment,
rebuild it in four seconds. After that, `.venv` stops being mysterious.
...
This is the step that decides whether today worked. Write it for **the version
of you that has forgotten everything.** That person is real and they turn up
in October.
...
Another pair clones your repo and runs it **using only your README**. You may
not help them. You do the same to theirs.
...
Almost every README fails the first time. That is the exercise, and it is the
most useful twenty minutes of the day.

## 4 · Fix and push

Fix your README from the list you were handed. Commit. Push. That is the last
commit of day 1.
...
Run the clone test on yourselves: a fresh clone into a new folder, and follow
your own README literally, doing nothing it does not tell you to do.
